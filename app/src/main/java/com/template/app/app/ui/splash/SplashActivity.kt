...
import com.template.app.databinding.ActivitySplashBinding
            ...
            viewModel.isSetupFinished.observeOnce(
                ...
                getResultEventObserver(action = {
                    ...
                    when (throwable) {
                        ...
                        is ErrorLoginException -> startActivity(navigator.navigateToLogin())
                        else -> {
                            throwable.printStackTrace()
                            viewModel.logout().observe(
                                this,
                                getResultEventObserver({
                                    startActivity(navigator.navigateToLogin())
                                }, { e, _ ->
                                    e.printStackTrace()
                                    startActivity(navigator.navigateToLogin())
                                })
